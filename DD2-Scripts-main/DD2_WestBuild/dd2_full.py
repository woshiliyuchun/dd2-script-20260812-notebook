...
def main():
    ...
    try:
        while True:
            ...
            xy = locate_image(hwnd, r"F:\DD2脚本\额外奖励.png", '额外奖励区域', confidence=0.8)
            if xy:
                print("🎁 额外奖励")
                time.sleep(3.0)
                humanized_press("ENTER")
            ...
            xy = locate_image(hwnd, r"F:\DD2脚本\replay.png", 'replay区域', confidence=0.8)
            if xy:
                print("🔄 replay")
                print(f"第{k}轮完成")
                time.sleep(3.0)
                ...
                xy = locate_image(hwnd, r"F:\DD2脚本\失败重来.png", '失败重来区域', confidence=0.8)
                if xy:
                    print("💀 失败，重来")
                    time.sleep(2.0)
                    humanized_press("N")
                    ...
                    print("🔍 等待replay界面...")
                    for _ in range(20):
                        xy_replay = locate_image(hwnd, r"F:\DD2脚本\replay.png", 'replay区域', confidence=0.8)
                        if xy_replay:
                            print("✅ 找到replay按钮")
