...
REGION = (0.35, 0.3, 0.8, 1.2)
TEMPLATE_PATH = r"D:\DD2脚本\额外奖励.png"
...
def main():
    ...
    from PIL import Image
    output_path = r"D:\DD2脚本\extra_reward_screenshot.png"
    ...
    if max_val >= 0.8:
        ...
        print(f"   复制 {output_path} 覆盖 {TEMPLATE_PATH}")
